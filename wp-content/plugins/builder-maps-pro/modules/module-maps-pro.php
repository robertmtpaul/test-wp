...
class TB_Maps_Pro_Module extends Themify_Builder_Component_Module {
	...
	public function get_options() {
        $providers = Maps_Pro_Data_Provider_Container::get_instance()->get_providers();
	...
	protected function _visual_template() {
		...
		<#	
		var draggable = 'enable' === data.draggable_map ||  'desktop_only' === data.draggable_map  ? 'enable' : 'disable';
		#>
