...
class Builder_Contact
{
    ...
    public function contact_send() {
		...
		if ( $module_settings['field_optin_active'] && isset( $_POST['contact-optin'] ) && $_POST['contact-optin'] == '1' ) {
			...
			$optin_instance = method_exists('Builder_Optin_Service', 'get_providers')?Builder_Optin_Service::get_providers( $provider ):Builder_Optin_Services_Container::get_instance()->get_provider($provider);
			if ( $optin_instance ) {
