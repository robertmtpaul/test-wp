		...
		$typewriter = array(
			self::get_expand( 'bg', array(
				self::get_tab( array(
					'n' => array(
						'options' => array(
							self::get_color( '.module .typewriter-main-tag .typewriter-span *', 'span_background_color', __( 'Highlight Background', 'themify' ), 'background-color' )
						)
					),
					'h' => array(
						'options' => array(
							self::get_color( '.module .typewriter-main-tag .typewriter-span span', 's_b_c', __( 'Highlight Background', 'themify' ), 'background-color', 'h' )
						)
					)
				) )
			) ),
			self::get_expand( 'f', array(
				self::get_tab( array(
					'n' => array(
						'options' => array(
							self::get_color( '.module .typewriter-main-tag .typewriter-span *', 'span_font_color', __( 'Highlight Text Color', 'themify' ) )
						)
					),
					'h' => array(
						'options' => array(
							self::get_color( '.module .typewriter-main-tag .typewriter-span span', 's_f_c', __( 'Highlight Text Color', 'themify' ), null, 'h' )
						)
					)
				) )
			) ),
			...
			self::get_expand( 'p', array(
				self::get_tab( array(
					'n' => array(
						'options' => array(
							self::get_padding( '.module .typewriter-main-tag .typewriter-span span', 'span_padding' ),
						)
					),
					'h' => array(
						'options' => array(
							self::get_padding( '.module .typewriter-main-tag .typewriter-span span', 's_p', 'h' ),
						)
					)
				) )
			) ),
			...
			self::get_expand( 'b', array(
				self::get_tab( array(
					'n' => array(
						'options' => array(
							self::get_border( '.module .typewriter-main-tag .typewriter-span span', 'span_border' ) )
					),
					'h' => array(
						'options' => array(
							self::get_border( '.module .typewriter-main-tag .typewriter-span span', 's_b', 'h' )
						)
					)
				) )
			) )
