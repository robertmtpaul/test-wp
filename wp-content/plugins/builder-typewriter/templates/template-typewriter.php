...
$container_class = apply_filters('themify_builder_module_classes', array('module','module-' . $args['mod_name'],$element_id,$fields_args['add_css_text']), $args['mod_name'], $element_id, $fields_args);
...
?>
    <?php if ($style!== '') : ?>
    <style>
	.<?php echo $element_id?> .typewriter-main-tag .typewriter-span span{<?php echo $style?>}
    </style>
    <?php endif ?>
